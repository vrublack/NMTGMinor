...
cd $current_dir
python3 preprocess_style.py -join_vocab -train_style1 ${data_dir}/${name}/train/train.0 -train_style2 ${data_dir}/${name}/train/train.1 -valid_style1 ${data_dir}/${name}/valid/valid.0 -valid_style2 ${data_dir}/${name}/valid/valid.1 -save_data ${data_dir}/${name}/model_prepr
