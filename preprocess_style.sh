...
-train_style1_rm ${data_dir}/${name}/train/train-del.0 \
-train_style2_rm ${data_dir}/${name}/train/train-del.1 \
-valid_style1 ${data_dir}/${name}/valid/valid.0 \
-valid_style2 ${data_dir}/${name}/valid/valid.1 \
-valid_style1_rm ${data_dir}/${name}/valid/valid-del.0 \
-valid_style2_rm ${data_dir}/${name}/valid/valid-del.1 \
