...
with open('/Users/valentin/PycharmProjects/text_style_transfer/model/data/train.0') as f:
...
with open('/Users/valentin/PycharmProjects/text_style_transfer/model/data/train.1') as f:
...
with open('/Users/valentin/PycharmProjects/text_style_transfer/model/data/train-del-new.0', 'w') as f:
    for line in lines_0:
        f.write(removeSalient(line, dist_0, dist_1) + '\n')

with open('/Users/valentin/PycharmProjects/text_style_transfer/model/data/train-del-new.1', 'w') as f:
    for line in lines_1:
