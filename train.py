...
parser.add_argument('-w_adv1', type=float, default=1.0,
                    help='Weight of adv1 loss (cross-entropy of classifier, so that the classifier is good)')
parser.add_argument('-w_adv2', type=float, default=1.0,
                    help='Weight adv2 loss (entropy of classifier, so that the classifier is bad')
